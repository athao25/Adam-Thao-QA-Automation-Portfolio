...
test.describe('Checkout Flow', () => {
  ...
  test('should complete full checkout flow', { tag: ['@smoke'] }, async ({ cartPage, checkoutPage }) => {
  ...
  test('should display error when first name is empty', { tag: ['@regression'] }, async ({
    cartPage,
    checkoutPage,
  }) => {
    await cartPage.proceedToCheckout();
  ...
  test('should display error when last name is empty', { tag: ['@regression'] }, async ({
    cartPage,
    checkoutPage,
  }) => {
    await cartPage.proceedToCheckout();
  ...
  test('should display error when postal code is empty', { tag: ['@regression'] }, async ({
    cartPage,
    checkoutPage,
  }) => {
    await cartPage.proceedToCheckout();
  ...
  test('should calculate correct totals', { tag: ['@regression'] }, async ({ cartPage, checkoutPage }) => {
    await cartPage.proceedToCheckout();
